    ...
    public class GreenLightGameController {
        ...
        public class PleaseProvideControllerClassName {
            ...
            public class PleaseProvideControllerClassName {
                ...
                @FXML
                private StackPane circleContainer; // Reference to the StackPane in FXML

                private Text[] xCircles; // Array to store X circles
                ...
                void MediumButtonPressed(ActionEvent event) {
                    ...
                    void CheckButtonPressed (ActionEvent event){
                        ...
                        if (userGuess.equalsIgnoreCase(correctWord)) {
                            ...
                            for (int i = 0; i < xCircles.length - remainingTries; i++) {
                                xCircles[i].setVisible(false); // Hide X circles for incorrect guesses
                            }
